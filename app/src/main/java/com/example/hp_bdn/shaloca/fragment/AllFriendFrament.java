...
public class AllFriendFrament extends Fragment  implements FriendRecyclerViewAdapter.FriendRecyclerListener  {
    private RecyclerView recyclerViewFriend ;
    private List<Friend> friends ;
    private FriendRecyclerViewAdapter friendRecyclerViewAdapter ;
    // contructor
    public static AllFriendFrament newInstance() {
        AllFriendFrament allFriendFrament = new AllFriendFrament();
        Bundle args = new Bundle();
        allFriendFrament.setArguments(args);
        return allFriendFrament;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.allfriend_fragment, container, false);
